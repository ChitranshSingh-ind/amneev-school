      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-end mb-16 sm:mb-20">
          <div className="lg:col-span-7">
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-sand-50 leading-tight">
          ...
          <div className="lg:col-span-5">
            <p className="text-sm sm:text-base text-sand-200 leading-relaxed font-normal">
              Affiliated with the Central Board of Secondary Education (CBSE No. 2131535), AMNEEV provides structured academic rigor and national benchmarking for students in Etawah.
            </p>
          </div>
        </div>

        {/* 6 Key Milestones Ledger */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 py-10 border-y border-forest-800">
          {siteContent.stats.map((stat, idx) => (
            <div key={idx} className="space-y-1">
              ...
              <div className="font-sans text-xs sm:text-sm font-semibold text-sand-100 uppercase tracking-wider">
                {stat.label}
              </div>
        ...
        <div className="mt-16 sm:mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {siteContent.collaborations.slice(0, 3).map((partner, idx) => (
              <div
                key={idx}
                className="p-6 rounded-sm bg-forest-900/60 border border-forest-800 space-y-3"
              >
                <div className="font-serif text-xl font-bold text-sand-50">
                  {partner.name}
                </div>
                <div className="text-xs uppercase font-mono tracking-wider text-brass-400">
                  {partner.type}
                </div>
